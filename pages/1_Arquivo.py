...
#
#
# ArchiveNotificationContent = ApiConnection.get_spreadsheet_notifications()
#
...
#
#
# dataframeAPI = ApiConnection.get_archive_spreadsheet_content()  # ou outro df com base na planilha
#
